...
public class TrainPositionAlgorithmTests {
	 ...
	 * @param positionTestCase Test case to execute
	 */
...
/*			assertEquals(actualPositionUpdate.getTimeObserved().getTimeInMillis(), expectedPositionUpdate.getTimeObserved().getTimeInMillis(), tolerance);
			assertEquals(actualPositionUpdate.getValue().getX(), expectedPositionUpdate.getValue().getX(), tolerance);
			assertEquals(actualPositionUpdate.getValue().getY(), expectedPositionUpdate.getValue().getY(), tolerance);
			assertEquals(actualPositionUpdate.getValue().getZ(), expectedPositionUpdate.getValue().getZ(), tolerance); */
		}
	}
