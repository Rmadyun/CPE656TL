package edu.uah.cpe.traintrax.cycles_johnson_meyer;
...
public class ElementaryCyclesSearch {
	...
	public ElementaryCyclesSearch(boolean[][] matrix, Object[] graphNodes) {
		...
		this.adjList = edu.uah.cpe.traintrax.cycles_johnson_meyer.AdjacencyList.getAdjacencyList(matrix);
	}
	...
	public List getElementaryCycles() {
		...
		edu.uah.cpe.traintrax.cycles_johnson_meyer.StrongConnectedComponents sccs = new edu.uah.cpe.traintrax.cycles_johnson_meyer.StrongConnectedComponents(this.adjList);
		int s = 0;
