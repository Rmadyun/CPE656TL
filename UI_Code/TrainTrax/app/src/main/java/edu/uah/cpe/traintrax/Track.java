...
public class Track {
    ...
    /**
     * Retrieves a list of all of the track blocks that belong to the track
     *
     * @return a list of all of the track blocks that belong to the track
     */
    public List<TrackBlockModel> getTrackBlockModels() {
        return trackBlockModels;
    }
}
